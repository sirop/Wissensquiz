/*! \mainpage
  ...
  which is more a proof of concept than something serious.
  ...
  You can have as many as quiz categories as you like.
  Of course, their number should not exceed the maximum integer of your system. ;)
